...
public class RecyclerViewAdapterBeerlistPage extends RecyclerView.Adapter<RecyclerViewAdapterBeerlistPage.ViewHolder> {
    ...
    public RecyclerViewAdapterBeerlistPage(Context mContext, ArrayList<String> mbeer_id, ArrayList<String> mbeer_name, ArrayList<String> mbeer_volume, ArrayList<String> mbeer_price) {
